...
export class WorldExplorerHTMLView implements WorldExplorerView {
  ...
  getChartFormDetails(): {
    ...
    return { countryId, indicator, fromYear, toYear, chartType };
  }
